...
% Component types
\tikzstyle{Optimization} = [rounded rectangle,draw,fill=tableau4!80,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{LP_Optimization} = [rectangle,draw,fill=tableau4!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{Analysis} = [rectangle,draw,fill=tableau10!100,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{ImplicitAnalysis} = [rectangle,draw,fill=salmon!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{Function} = [rectangle,draw,fill=tableau2!40,inner sep=6pt,minimum height=1cm,text badly centered]
