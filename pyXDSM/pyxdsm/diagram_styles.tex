...
% \definecolor{tableau10}{RGB}{204, 255, 204}

% \definecolor{tableau0}{RGB}{77, 121, 168}
% \definecolor{tableau1}{RGB}{242, 201, 217}
% \definecolor{tableau2}{RGB}{255, 87, 88}
% \definecolor{tableau3}{RGB}{118, 183, 178}
% \definecolor{tableau4}{RGB}{180, 180, 255}
% \definecolor{tableau5}{RGB}{255, 230, 204}
% \definecolor{tableau6}{RGB}{176, 121, 162}
% \definecolor{tableau7}{RGB}{255, 157, 167}
% \definecolor{tableau8}{RGB}{255, 250, 216}
...
% Blue
% \definecolor{red}{HTML}{A0CBE8}
\definecolor{blue}{RGB}{180, 180, 255}
...
% Yellow
% \definecolor{yellow}{HTML}{F1CE63}
\definecolor{yellow}{RGB}{255, 250, 216}

% Salmon
% \definecolor{salmon}{HTML}{FF9D9A}
\definecolor{salmon}{RGB}{242, 201, 217}

% Component types
\tikzstyle{Optimization} = [rounded rectangle,draw,fill=blue!80,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{LP_Optimization} = [rectangle,draw,fill=blue!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{Analysis} = [rectangle,draw,fill=green!100,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{ImplicitAnalysis} = [rectangle,draw,fill=salmon!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{Function} = [rectangle,draw,fill=green!40,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{MDA} = [rounded rectangle,draw,fill=yellow!100,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{Metamodel} = [rectangle,draw,fill=yellow!100,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{DOE} = [rounded rectangle,draw,fill=yellow8!50,inner sep=6pt,minimum height=1cm,text badly centered]
